...
public class SectionUtil {
    ...
    public static POCDMT000002UK01StructuredBody getStructuredBody(POCDMT000002UK01ClinicalDocument1 clinicalDocument) {
    ...
    public static Predicate<POCDMT000002UK01Section> sectionHasCode(String system, String code) {
    ...
    public static List<POCDMT000002UK01Section> getSectionsOfType(POCDMT000002UK01StructuredBody structuredBody,
    ...
    public static Predicate<? super POCDMT000002UK01Entry> entryHasTemplate(String template) {
    ...
    public static List<POCDMT000002UK01Entry> getEntriesOfType(POCDMT000002UK01StructuredBody structuredBody,
                                                               String template) {
        if (structuredBody == null) {
            return Collections.emptyList();
        }
